...
export function createPlayTemplate(session: AppSession, input: { designId: string; name: string; description?: string; tags?: string[]; templateKind?: string; layer?: string }): Promise<PlayTemplate> {
