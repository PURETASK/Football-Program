...
| Stage 0 owner approval evidence workflow | Authenticated program-owner submission and inspection of registry-linked approval evidence with non-activating safety flags, plus a value-free owner-review packet generator and composed synthetic review bundle | `src/nfl_fidos/stage0_approval.py`, `src/nfl_fidos/stage0_owner_packet.py`, `scripts/stage0_owner_approval_preflight.py`, `scripts/stage0_review_bundle.py`, `src/nfl_fidos/api.py`, `ui/operator-dashboard.html`, `runbooks/stage-0-owner-approval.md`, `runbooks/demo-seed-data.md`, `tests/test_stage0_approval_api.py`, `tests/test_stage0_owner_packet.py`, `tests/test_stage0_review_bundle.py` | Preflight packet, synthetic inventory, file-hash evidence, and non-activating bundle pass; real program-owner approval and control-plane advancement remain pending |
