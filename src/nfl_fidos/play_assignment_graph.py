...
GRAPH_FIELDS = {
    ...
    "exchange_concept",
    "blocking_primitive",
    "block_target_element_id",
    "block_partner_element_id",
    "protection_mode",
    "protection_target_element_id",
    "protection_slide_direction",
    "protection_scan_order",
...
def build_assignment_graph(design: dict[str, Any]) -> dict[str, Any]:
    ...
    for element in elements:
        ...
        nodes.append({
            ...
            "block_partner_element_id": element.get("block_partner_element_id"),
            "protection_target_element_id": element.get("protection_target_element_id"),
            "protection_slide_direction": element.get("protection_slide_direction"),
            "protection_scan_order": element.get("protection_scan_order"),
